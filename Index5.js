...
const letraPasaporte = prompt("Ingrese la primer letra de su pasaporte");
const nacional = letraPasaporte == "a" || letraPasaporte == "A"
console.log("Es turista Nacional? "+nacional);

const extranjero = !nacional
